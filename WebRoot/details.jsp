    ...
    <div class="basic-info">
        ...
        <div class="basis-info-text">
            ...
            <div >
                ...
                <p class="login-a"id="test">
                    <a href="webLogin.jsp">登录</a>
                    <a href="ForwardBMpage?jobid='<%=job_id%>'" >极速报名</a>
                    <!-- a href="javascript:;" class="qxbm">取消</a> -->
                </p>
            </div>
...
<script>
 ...
 function openBaoming() {
     alert(1);
     //var url="ForwardBMpage?jobid=<%=job_id%>"
     //window.open(url);
     location.href="ForwardBMpage?jobid=<%=job_id%>";
 }
