...
function mySearch(value,name){
	...
	<body>	
		...
		<form action="T_to_push_Servlet?pageNo=1&city=boss" method="post">
	<div id="panel">
	<h5 class="head">查询</h5>
	<div class="content" >
...
<div class=" fy-r" >
    [<a href="T_to_push_Servlet?pageNo=1&cityId=${cityId }&school=${school }&sex=${sex }&tel=${tel }&city=boss" >首页</a> 
                | <a href="T_to_push_Servlet?pageNo=${page.prePage }&cityId=${cityId }&school=${school }&sex=${sex }&tel=${tel }&city=boss" >上一页</a> | 
                <a href="T_to_push_Servlet?pageNo=${page.nextPage}&cityId=${cityId }&school=${school }&sex=${sex }&tel=${tel }&city=boss" >下一页</a> | 
                <a href="T_to_push_Servlet?pageNo=${page.bottomPage}&cityId=${cityId }&school=${school }&sex=${sex }&tel=${tel }&city=boss" >末页</a>] 
...
<div id="w" class="easyui-window hide " title="兼职信息" data-options="iconCls:'icon-save'" closed="true" style="width:680px;height:500px;padding:0px;">  
...
<%--<div id="tools">
	<input class="easyui-searchbox" data-options="searcher:mySearch,menu:'#mm'"/>
</div>
<div id="mm" style="width:120px">
    <div data-options="name:'name'">兼职名称</div>
</div>
