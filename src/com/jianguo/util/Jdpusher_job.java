...
public class Jdpusher_job {
	protected static final Logger LOG = LoggerFactory.getLogger(Jdpusher_job.class);

	private static final String appKey = "b7d6a9432f425319c952ffd3";//IOS企业版
	private static final String masterSecret = "2f923496d668cd3957760f30";//IOS企业版
//	private static final String appKey = "d66d914506ad9de7821ddf83";//IOSAppstare版
//	private static final String masterSecret = "147f554a1c63289f28860c83";//IOSAppstare版
	...
	public static void sendPush(String title,String username,String job_name,String job_id) {
		...
		// 生成推送的内容，这里我们先测试全部推送
		PushPayload payload = buildPushObject_all_alias_alert(title,username,job_name,job_id);
...
//			payLoad.addSound(sound);
	...
	public static PushPayload buildPushObject_all_alias_alert(String title,String username,String job_name,String job_id) {
...
//					.setNotification(Notification.alert(title))
					.setNotification(Notification.android(title,"兼果", params))
					.build();
