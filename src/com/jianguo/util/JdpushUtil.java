...
//	private static final String masterSecret = "147f554a1c63289f28860c83";//IOSAppstare版
	...
	public static void sendPush(JpushBean bean) {
		jpushClient = new JPushClient(bean.getMasterSecret(), bean.getAppKey(),3);
...
//			payLoad.addSound(sound);
	...
	public static PushPayload buildPushObject_all_alias_alert(JpushBean bean) {
						...
						Notification
								...
								.addPlatformNotification(
										AndroidNotification.newBuilder()
												...
												.addExtra("type", bean.getType())
												.addExtra("jobid", bean.getJobid())
												.build())
								.addPlatformNotification(
										IosNotification
												.newBuilder()
												.incrBadge(1)
												.addExtra("type", bean.getType()).addExtra("jobid", bean.getJobid()).build())
