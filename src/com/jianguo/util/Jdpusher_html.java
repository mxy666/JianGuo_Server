...
public class Jdpusher_html {
	protected static final Logger LOG = LoggerFactory.getLogger(Jdpusher_html.class);
...
//	private static final String masterSecret = "147f554a1c63289f28860c83";//IOSAppstare版
	...
	public static void sendPush(String title,String username,String html_url) {
		...
		// 生成推送的内容，这里我们先测试全部推送
		PushPayload payload = buildPushObject_all_alias_alert(title,username,html_url);
...
//			payLoad.addSound(sound);
	...
	public static PushPayload buildPushObject_all_alias_alert(String title,String username,String html_url) {
		
			Map params =  new HashMap();
			params.put("username", username);
			params.put("type", "4");
			params.put("html_url", html_url);
