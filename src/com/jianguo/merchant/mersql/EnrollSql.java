...
public class EnrollSql {
	
	public static boolean check_login_id_job_id(String login_id,String job_id) throws SQLException {
	...
	public static boolean check_login_id_job_id2(String login_id,String job_id,String status) throws SQLException {
		Connection conn=DButil.getCon();
		boolean b = true;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public static int insert(String login_id,String job_id,String status,String login_time,String state,String type) throws SQLException {
		   int num=0;
		   Connection conn=DButil.getCon();
	...
	public static T_enroll_Bean select_login_id_job_id(String login_id,String job_id) throws SQLException {
		ResultSet rs=null;
	...
	public static T_enroll_Bean select_login_id_job_time(String login_id,String job_id) throws SQLException {
		ResultSet rs=null;
		T_enroll_Bean t_enroll = new T_enroll_Bean();
		Connection conn=DButil.getCon();
		String sql = "select status,login_time from t_enroll where login_id=? and job_id=?";
		PreparedStatement psmt = DButil.getPstm(conn, sql);
			psmt.setString(1,login_id);
			psmt.setString(2,job_id);
			rs=psmt.executeQuery();
...
//				t_enroll.setState(rs.getInt("state"));
	...
	public static List<T_enroll_Bean> select_job_id_status_count(String job_id,String job_id_nv,String status){
		...
		Connection conn=DButil.getCon();
		String sql = "select * from t_enroll where job_id=?  and status=? and state=0";
		PreparedStatement psmt = DButil.getPstm(conn, sql);
		try {
			psmt.setString(1,job_id);
			//psmt.setString(2,job_id_nv);
	...
	//Ω·À„
	public static List<T_enroll_Bean> select_job_id_status_countnew(String job_id,String status) throws SQLException {
		List<T_enroll_Bean> list=new ArrayList<T_enroll_Bean>();
		ResultSet rs=null;
...
//				t_enroll.setState(rs.getInt("state"));
	...
	public static int update_state(String state,String status,String login_id,String job_id) throws SQLException {
		int num=0;
			Connection conn=DButil.getCon();
			String sql = "update t_enroll set state=?, status=? where login_id=? and job_id=?";
			PreparedStatement psmt = DButil.getPstm(conn, sql);
