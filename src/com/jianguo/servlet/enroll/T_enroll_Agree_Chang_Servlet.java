...
public class T_enroll_Agree_Chang_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public T_enroll_Agree_Chang_Servlet() {
		super();
	}
	...
	//http://192.168.1.233/JianGuo_Server/T_enroll_Agree_Chang_Servlet?only=D676F8B429AC1D11E2F0BE13493190AE&login_id=2&job_id=1
	//http://101.200.205.243:8080/T_enroll_Agree_Chang_Servlet?only=C978AF1CD86BC4A761985B762A5C6DC1&job_id=24&offer=13
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	throws ServletException, IOException {
		System.out.println("---T_enroll_Agree_Chang_Servlet---");
		request.setCharacterEncoding("utf-8");
		response.setContentType("text/html;charset=utf-8");
