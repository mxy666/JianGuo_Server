...
public class T_Job_info_Select_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public T_Job_info_Select_Servlet() {
		super();
	}
	...
	//http://192.168.1.132/JianGuo_Server/T_Job_info_Select_Servlet?only=8466964517D80C38BAE7C8FAA5B655C7&login_id=78&job_id=129
	//http://101.200.205.243:8080/T_Job_info_Select_Servlet?only=DB0A8D73654EC9CE1C172B95E84F3501&tel=111118101s050625&login_id=45
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	throws ServletException, IOException {
		System.out.println("---T_Job_info_Select_Servlet---");
		request.setCharacterEncoding("utf-8");
		response.setContentType("text/html;charset=utf-8");
...
//		String alike =request.getParameter("alike");
		...
		if(only.equals(ss_only) || only.equals(ss_only2) || only.equals(ss_only3)){
			...
			T_merchant_Bean t_merchant = T_merchant_Sql.select_id(t_jobs.getMerchant_id()+"");
			...
			boolean b2 = T_attent_Sql.check_login_id_follow(login_id, t_jobs.getMerchant_id()+"");
