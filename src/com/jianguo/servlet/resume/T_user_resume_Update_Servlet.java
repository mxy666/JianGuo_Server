...
public class T_user_resume_Update_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public T_user_resume_Update_Servlet() {
		super();
	}
	...
	//http://192.168.1.233/JianGuo_Server/T_user_resume_Update_Servlet?only=3016E9490D2C47F18954E1277DCA873E&tel=18631017353&password=3
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	throws ServletException, IOException {
		System.out.println("---T_user_resume_Update_Servlet---");
		request.setCharacterEncoding("utf-8");
		response.setContentType("text/html;charset=utf-8");
...
//		System.out.println(intoschool_date);
//		System.out.println(sex);
//		System.out.println(height);
//		System.out.println(student);
//		System.out.println(birth_date);
//		System.out.println(shoe_size);
//		System.out.println(clothing_size);
...
//		System.out.println(label);
		...
		//------------------访问限制--------结束----------------------
			...
			if(t_user_login.getTel() == "0" || t_user_login.getTel().equals("0")){
				...
				int i = T_user_resume_Sql.update( nickname, name, name_image, school, intoschool_date, sex, str_height, student, birth_date, shoe_size, clothing_size, sign, label,login_id);
				
				if(i == 1){
					T_user_info_Sql.update(name, name_image, school, login_id);
